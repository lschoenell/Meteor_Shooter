...
class Ammo:
    ...
    # offset, da das eigentliche Sprite nicht die obere Spitze da hat, wo das Bild tatsaechlich oben endet
    sprite_offset_y: int = 26
    # Liste erstellen, damit alle geschossenen Schuesse gerendert werden koennen statt nur einer
    ammo_array: list = []
    ...
    def update(self, dt: float) -> None:
        """
        Updated die y-Position der Ammo so, dass sie nach oben schiesst und updated auch die Position des collisionrects
    ...
    def add_ammo(self) -> None:
        """
        fuegt dem ammo array ein Ammo Objekt an der Position des Rohrs des Panzers zu
        """
    ...
    def draw_ammo(self, screen: pygame.Surface) -> None:
        """
        rendert alle Objekte des ammo arrays auf den gegebenen screen und loescht alle Ammo Objekte, die ausserhalb des Bildschirms fliegen
